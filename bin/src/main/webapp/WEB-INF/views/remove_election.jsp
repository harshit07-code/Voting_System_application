...
<head>
<meta charset="UTF-8">
<title>Remove Election form</title>
</head>
...
<div style="max-width:900px; margin:30px auto 20px; text-align:right;">
    <form action="ShowElectionTable" method="GET">
        <input type="hidden" name="page" value="remove_election">
...
<div style="
    ...
    box-shadow:0 10px 30px rgba(0,0,0,0.12);
">
    <h3 style="margin-top:0; color:#1f2937;">Remove form</h3>

    <form action="removeElection" method="POST">
        <label>Select the Election you want to remove :</label><br><br>
