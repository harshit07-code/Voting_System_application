...
<input type="text" name="candidateName"  required  placeholder="Candidate Name"
       style="width:100%; padding:10px; margin-bottom:12px; border-radius:10px; border:1px solid #d1d5db;">

<input type="number" name="candidateAge"  required  placeholder="Candidate Age"
       style="width:100%; padding:10px; margin-bottom:12px; border-radius:10px; border:1px solid #d1d5db;">

<input type="text" name="partyName"  required placeholder="Party Name"
       style="width:100%; padding:10px; margin-bottom:12px; border-radius:10px; border:1px solid #d1d5db;">
Profile Photo
...
<input type="text" name="candidateName"  required value="${candidate.candidateName}"
       style="width:100%; padding:10px; margin-bottom:12px; border-radius:10px; border:1px solid #d1d5db;">

<input type="number" name="candidateAge"  required value="${candidate.candidateAge}"
       style="width:100%; padding:10px; margin-bottom:12px; border-radius:10px; border:1px solid #d1d5db;">

<input type="text" name="partyName" required   value="${candidate.partyName}"
       style="width:100%; padding:10px; margin-bottom:12px; border-radius:10px; border:1px solid #d1d5db;">

<input type="text" name="candidateElectionName" required  value="${candidate.candidateElectionName}"
