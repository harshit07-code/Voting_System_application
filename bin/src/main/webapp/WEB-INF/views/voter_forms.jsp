...
<tr style="text-align:center; border-bottom:1px solid #e5e7eb;">
   ...
   <td style="padding:8px;">
        ...
        <form action="removeVoter" method="POST" style="display:inline;">                          <!--  Request goes to voter crud controller  -->
            <input type="hidden" name="voterId" value="${v.voterId}">
...
<!-- <input type="text" name="phoneNO" style="width:100%; padding:10px; margin:6px 0 14px; border-radius:10px; border:1px solid #d1d5db;">
<label>Voter Phone Number</label> -->
<input type="text"
       name="phoneNO"
       maxlength="10"
       ...
       style="width:100%; padding:10px; margin:6px 0 14px; border-radius:10px; border:1px solid #d1d5db;">
...
"> -->
 ...
 <c:redirect url="/showVoterForm" />

<!-- <form action="showVoterForm" method="Get">
<input type="text" name="voterId" placeholder="Enter Voter Id"
       style="width:100%; padding:10px; margin-bottom:18px; border-radius:10px; border:1px solid #d1d5db;">  Changed oon 31-01-2026
